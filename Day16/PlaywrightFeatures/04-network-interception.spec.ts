/* When you dont have real server reafy in that case you can go for network inteception 
...
test.only(`Network interception using Salesforce login (Mocked)`, async ({ page }) => {
